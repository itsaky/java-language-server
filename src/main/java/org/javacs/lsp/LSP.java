...
public class LSP {
    ...
    static Message parseMessage(String token) {
        ...
        try {
            ...
            java.io.StringWriter r = new java.io.StringWriter();
            th.printStackTrace(new java.io.PrintWriter(r));
            LOG.warning(token + "\n" + r.toString());
        }
        return null;
    }
    ...
    private static void writeClient(OutputStream client, String messageText) {
        var messageBytes = messageText.concat("\n").getBytes(UTF_8);
        try {
    ...
    public static void connect(
        ...
        var pending = new ArrayBlockingQueue<Message>(100);
            ...
            public void run() {
                ...
                try {
                    ...
                    while (true) {
                        ...
                        // If line is null, we may have been disconnected...
                        if(line == null) break;
                        Message msg = null;
                        try {
        ...
        while (true) {
            ...
            try {
                ...
                if(r != null)
                    LOG.info("Got message with method: " + r.method);
            } catch (Exception e) {
                LOG.log(Level.SEVERE, e.getMessage(), e);
                continue;
            }
